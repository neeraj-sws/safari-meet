            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 login-left">
                    <div class="login-form-box py-md-5">
                        ...
                        <h2 class="mb-4">Sign Up & Start Your Safari Journey</h2>
                        <form wire:submit.prevent="register" class="user-store-form row">
                            <div class="mb-3 col-12">
                                <label class="form-label text-white">Name <span>*</span></label>
                                <input type="text" wire:model="name" class="form-control text-capitalize"
                                    placeholder="Enter Name" oninput="filterAndFormatInputs(this,{allowAlpha:true})" />
                                @error('name')
                            ...
                            <div class="mb-3 col-lg-6 col-md-12 col-sm-6">
                                ...
                                <input type="text" wire:model="phone" class="form-control"
                                    placeholder="Enter Phone Number" maxlength="10" pattern="\d{10}"
                            ...
                            <div class="col-12">
                                <div class="login-btn loginbtntext rounded-3 text-center mb-2">
                                    <button class="btn rounded-3 text-white fw-semibold w-100" type="submit"
                                        {{--  @if (!$this->canSubmit) disabled @endif --}} wire:loading.attr="disabled">
                            ...
                            <div class="col-12 m-0">
                                <div class="form-links d-flex justify-content-center flex-wrap">
                                    <p class="text-white fw-normal small m-0">Already registered?
