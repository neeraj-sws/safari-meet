                            ...
                            <ul class="list-unstyled mb-0  package-lists">
                                <li class="mb-2">
                                    <div class="d-flex align-items-center flex-wrap mb-3">
                                        ...
                                        <p class="mb-0 list-paragraph text-dark">{{$package->park->title}},{{$package->park->state->name}}
                                        </p>
                                    </div>
                                </li>
                                <li class="mb-2">
                                ...
                                <li class="mb-2">
                                    <div class="d-flex align-items-center flex-wrap mb-3">
                                        ...
                                        <p class="mb-0 list-paragraph text-dark">₹{{$package->min_price_pp}} To ₹{{$package->max_price_pp}} per person</p>
                                    </div>
                                </li>
                                <li class="mb-2">
                                    <div class="d-flex align-items-center flex-wrap">
                                    ...
                                    <div class="card rounded-3">
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <div
                                                ...
                                                <a href="{{ route('package-detail',$similarPackage->uuid) }}"
