                        ...
                        <div class="filter-sidebar-content rounded-3 p-3">
                            ...
                            <div class="filter-group py-3 border-bottom mb-0">
                                ...
                                <select class="form-select" id="speciesSelect" wire:model.live="parkSelect">
                                    ...
                                    @foreach ($park_datas as $parkId => $parkValue)
                                    ...
                                    <div id="collapseSafari" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body pt-0">
                                            <div class="range-slider position-relative mb-3">
                                                ...
                                                <input type="range" id="minSafari" min="1" max="5"
                                                    step="1" value="1" class="position-absolute w-100"
                                                    style="pointer-events: none;">
                                                <input type="range" id="maxSafari" min="1" max="6"
                                                    step="1" value="6" class="position-absolute w-100">
                                            </div>
                                            <div class="range-values d-flex justify-content-between">
                   ...
                   <section id="join-shared-safari" class="mb-md--5 mb--3 pb--1">
                                        ...
                                        <div class="card-body p-0 rounded-bottom-3">
                                            ...
                                            <div class="card-body-inner p-2 pt-1">
                                                ...
                                                <div class="card-text">
                                                    ...
                                                    <div class="park-description border-bottom card-lines-divider pb-1 mb-1">
                                                        <p
                                                            class="mb-0">
                                                    ...
                                                    <div class="knowfor-list mb-2 d-flex align-items-center">
                                                        ...
                                                        <p class="mb-0 ps-2">October - March</p>
                                                    </div>
                                                    ...
                                                    <div class="knowfor-list mb-2">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="card-list-text d-flex align-items-center gap-1">
                                                                <img src="{{ asset('front-assets/images/icons/dot.svg') }}" alt="dot">
                                                                <p class="mb-0">Elephants</p>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <!-- Safari Type partition -->
                                                    <div class="knowfor-list">
                                                        <h6 class="mb-0">Safari Type:</h6>
                                                        <div
                                                            class="highlights d-flex align-items-center flex-wrap column-gap-2">
                                                            <div class="card-list-text d-flex align-items-center gap-1">
                                                                <i class="fa-solid fa-check link-text"></i>
                                                                <p class="mb-0">Jeep Safari</p>
                                                            </div>
                                                            <div class="card-list-text d-flex align-items-center gap-1">
                                                                <i class="fa-solid fa-check link-text"></i>
                                                                <p class="mb-0">Canter Safari</p>
                                                            </div>
                                                            <div class="card-list-text d-flex align-items-center gap-1">
                                                                <i class="fa-solid fa-check link-text"></i>
                                                                <p class="mb-0">Boat Safari</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div
                                                class="price-container text-center pb-3 pt-2">
                                                <a href="{{ route('park-details',$park->slug)}}"
                                                    class="btn btn-sm btn-primary blue-btn-hover border-0 rounded-1 px-3">View Details</a>
                                            </div>
                    ...
                    <section id="top-rated-park" class="mt-4 pt-2">
                        <div class="heading-text text-center mb-xl-4 mb-3">
                            <div class="">
                                <h2 class="mb-0 text-accent">Top Rated Shared-Safari</h2>
                            ...
                            <div class="item">
                                <div class="owl-slide text-center mx-auto">
                                    <div class="card park-card border-0 shadow-sm position-relative overflow-hidden">
                                        <img src="{{ asset($shareSafari->display_image) }}" class="img-fluid"
                                        ...
                                        <div
                                            ...
                                            <h3 class="top-park-title mb-0">{{ ucwords($shareSafari->title) }}</h3>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div class="">
                                                <h5 class="fw-semibold top-park-title">{{ ucwords($shareSafari->title) }}
                                                </h5>
                                            </div>
                                            <div class="d-flex align-items-end justify-content-between gap-1">
                                                <div class="">
                                                    <p class="mb-0 small">A popular destination in Uttarakhand, home
                                                        to tigers, elephants, and rich biodiversity.</p>
                                                </div>
                                                <a href="{{ route('shared-safari-detail',$shareSafari->slug)}}" class="readmorearrow text-decoration-none">
                                                    <i
