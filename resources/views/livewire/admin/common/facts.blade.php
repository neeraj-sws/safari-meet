            ...
            <div class="modal-content">
                <form wire:submit.prevent="storeActivity">
                    ...
                    <div class="modal-body">
                        ...
                        <button type="button" class="btn btn-secondary btn-sm" wire:click="addActivity">
                            + Add Fact
                        </button>
                    </div>
                            ...
                            @foreach ($facts as $fact)
                                <li class="list-group-item d-flex justify-content-between align-items-start">
                                    <div>
                                        ...
                                        <small>{{ $fact->short_description }}</small>
                                    </div>
                                    <button type="button" wire:click="deleteFact({{ $fact->id }})"
