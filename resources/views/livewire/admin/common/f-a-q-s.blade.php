<div>
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <button type="button" wire:click="addModel()" class="btn {{ $showForm ? 'btn-danger' : 'btn-primary' }}  btn-sm">
            ...
            <div class="card-body">
                <form wire:submit.prevent="store">
                    ...
                    <div class="mb-3">
                        ...
                        <select wire:model.live="faq_id" id="faq_id" class="form-select select2">
            ...
            @forelse ($data as $index => $item)
                <div class="border rounded p-3 mb-3 bg-light">
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="button" wire:click="confirmDelete({{ $item['park_faqs_id'] }}, 'delete')"
