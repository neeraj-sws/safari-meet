<div class="container" id="amanity">
    ...
    <div class="row g-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form wire:submit.prevent="{{ $isEditing ? 'update' : 'store' }}">
                        <div class="mb-3 form-group" x-data="{ title: @entangle('title') }">
                            <label for="title" class="form-label">Weather Name <span
                            ...
                            <input type="text" class="form-control  @error('title') is-invalid @enderror"
                                ...
                                placeholder="Enter Weather Name Here...">
                            @error('title')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3 form-group">
                            <label for="start_date" class="form-label">Start Month <span
                                    class="text-danger">*</span></label>
                            <select class="form-control select2 @error('start_date') is-invalid @enderror"
        ...
        '12' => 'December',
                        ...
                        <div class="mb-3 form-group">
                            <label for="end_date" class="form-label">End Month <span
                                    class="text-danger">*</span></label>
                            <select class="form-control select2 @error('end_date') is-invalid @enderror"
                    ...
                    <div class="table-responsive ecs-table">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="text-center">No Weather found.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
