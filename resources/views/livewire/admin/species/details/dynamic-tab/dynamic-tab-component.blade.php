                    ...
                    <div class="card-body">
                        ...
                        <div class="fm-menu">
                            <div class="list-group list-group-flush">
                                <a href="javascript:;"
                                    class="list-group-item py-1 {{ $activeTabe == 'InterestingFacts' ? 'active text-white' : '' }}"
                                    wire:click="changeTab('InterestingFacts')"><span>{{ $pageTitle }}</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div id="test-l" class="bs-stepper-pan">
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        @php $editorId =  $species->slug.'-' . $this->getId(); @endphp
