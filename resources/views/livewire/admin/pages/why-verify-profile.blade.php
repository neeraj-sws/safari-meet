<div>
    ...
    <div class="card">
        <div class="card-body">
            @php $editorId = 'editorText-' . $this->getId(); @endphp
            <livewire:admin.common.ckeditor-component model="editorText" :value="$editorText" editor-id="{{ $editorId }}"
                wire:model.defer="editorText" />
            @error('editorText')
            ...
            <div>
                ...
                {{-- <button type="submit" class="btn btn-warning" wire:loading.attr="disabled" wire:target.except="save">
                    Preview
