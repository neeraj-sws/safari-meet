                    ...
                    <form wire:submit.prevent="{{ $isEditing ? 'update' : 'store' }}">
                        ...
                        <div class="mb-3">
                         ...
                         <div class="d-flex gap-2">
                            ...
                            <button type="button" wire:click="resetForm" class="btn btn-sm btn-secondary">Cancel</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="card">
              <div class="card-header d-flex justify-content-end">
                    <div class="position-relative">
            			<input type="text" class="form-control ps-5" placeholder="Search..." wire:model.live.debounce.300ms="search" > <span class="position-absolute top-50 product-show translate-middle-y">
                                    ...
                                    <tr wire:key="{{ $item->id }}">
                                       ...
                                       <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <img src="{{ asset($item->display_image) }}" alt="Image" class="img-fluid" style="height: 40px; width: auto; object-fit: contain;">
