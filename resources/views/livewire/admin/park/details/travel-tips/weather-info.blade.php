                ...
                <form wire:submit.prevent="storeTraveTip">
                    <div class="row">
                        <div class="col-md-12 p-4 ">
                            @php $editorId = 'Weatherinfo-' . $this->getId(); @endphp
                            <livewire:admin.common.ckeditor-component model="Weather Info" :value="$weatherInfo"
                                editor-id="{{ $editorId }}" wire:model.defer="weatherInfo" />
                            @error('weatherInfo')
