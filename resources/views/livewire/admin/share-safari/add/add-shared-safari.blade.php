<div class="container">
    ...
    <div class="page-breadcrumb flex-wrap d-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a href="{{ route('admin.sharedsafari.share.safari') }}" class="btn btn-primary ms-auto" wire:navigate>
...
is-invalid
@enderror " placeholder="Enter title">
                        @error('title')
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            <input type="number" name="min_price_pp" id="min_price_pp" wire:model="min_price_pp"
                                oninput="minPricePPChange(this)"
                                oninput="filterAndFormatInputs(this,{allowNumbers:true})" min="1"
                                step="1" class="form-control   @error('min_price_pp') is-invalid @enderror "
                                placeholder="MIN">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="total_seats" id="total_seats" wire:model.live="total_seats"
                            oninput="totalSeatsChange(this)" oninput="filterAndFormatInputs(this,{allowNumbers:true})"
                            min="1" step="1"
    ...
    <script>
        ...
        window.minPricePPChange = function(e) {
            ...
            if (maxEl) {
                ...
                // Fallback to jQuery if element isn't present for some reason
