                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="characterstics_name"
                                            wire:model="characterstics_name" placeholder="Enter Information Name">
                                        ...
                                        {{-- <td>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" role="switch"
                                                    wire:change="toggleStatus({{ $characterstick->id }})" id="{{ $characterstick->id }}"
                                                    @checked($characterstick->status)>
                                            </div>
                                        </td> --}}
                                        {{-- <td>
                                            ...
                                            @if (!in_array($characterstick->id, [1, 2, 3, 4, 5]))
                                                <a href="javascript:void(0)"
                                                    wire:click="confirmDelete({{ $characterstick->id }})" title="Delete">
