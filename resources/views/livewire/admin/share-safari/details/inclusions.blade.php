    ...
    <div class="container">
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="fm-menu">
                            <div class="list-group list-group-flush">
                                <a href="javascript:;"
                                    class="list-group-item py-1 {{ $activeTabe == $type ? 'active text-white' : '' }}"
                                    wire:click="changeTab({{ $activeTabe }})"><span>{{ $type }}</span></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-lg-9">
                <livewire:admin.common.inclusion-exclusions-component :type="$type == 'Inclusion' ? 1 : 2" :model="$package" :table="$table" />
            </div>
        </div>
    </div>
</div>
