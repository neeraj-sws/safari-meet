                    ...
                    <form wire:submit.prevent="{{ $isEditing ? 'update' : 'store' }}">
                        <div class="mb-3" x-data="{ title: @entangle('title') }">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror"
                                oninput="filterAndFormatInputs(this,{allowedSpecialChars:'()-,/',allowAlpha:true}); "
                        ...
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <select class="form-control select2 @error('state') is-invalid @enderror " id="state"
                                    wire:model="state" placeholder="Select State">
                        ...
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <select class="form-control select2 @error('rating') is-invalid @enderror" id="rating"
                                    wire:model="rating" placeholder="Select Rating">
                                    <option value="">Select Rating</option>
                                    @for ($i = 1; $i <= 5; $i +=0.5) <option value="{{ $i }}" @selected($rating==$i)>
                                        {{ $i }}</option>
                                        @endfor
                                </select>
                                @error('rating')
