...
use App\Models\SpeciesCategory as Model;
...
class SpeciesCategories extends Component
{
    use WithPagination;
    ...
    public $pageTitle = 'Species Categories';

    public $model = Model::class;
    public $view = 'livewire.admin.species-category';
    ...
    public function rules()
    {
        ...
        return [
            'name' => array_merge(
                ...
                $this->isEditing
                    ? [Rule::unique($table, 'name')->ignore($this->itemId,'species_category_id')]
    ...
    public function delete()
    {
        ...
        $exists = SpeciesOverviewModel::where('species_category_id', $this->itemId)->exists();
