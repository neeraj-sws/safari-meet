...
class CreateUpdateSharedSafari extends Component
{
    ...
    {
        return view('livewire.admin.notification.create-update-shared-safari');
    }
    ...
    public function store()
    {
        ...
        $this->dispatch('swal:toast', ['type' => 'success', 'title' => '', 'message' => 'User Notification Update Successfully']);
    }
}
