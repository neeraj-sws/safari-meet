...
class SharedSafariDetailsTabs  extends Component
{
    use WithFileUploads;
    use WithPagination;

    public $model = SharedShafariTabs::class;
    public $view = 'livewire.admin.share-safari.shared-safari-details-tabs';
    ...
    {
        $this->validate([
            'characterstics_name' => 'required',
        ], [
            'characterstics_name.*' => 'The Information name field is required.'
        ]);
