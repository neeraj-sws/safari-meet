...
class FrontInclusionExclusionsComponent extends Component
{
    ...
    {
        return view('livewire.front.common.front-inclusion-exclusions-component');
    }
    ...
    public function addRow()
    {
        ...
        $this->items[] = ['icon' => $value, 'title' => '', 'id' => ''];
        $this->dispatch('initializeIconPicker');
    }
